...
namespace SAMMI.PP
{
    public partial class PP3800 : SAMMI.Windows.Forms.BaseMDIChildForm
    {
        ...
        public override void DoInquire()
        {
            ...
            try
            {
                ...
                //rtnDtTemp = helper.FillTable("USP_PP3800_S1", CommandType.StoredProcedure, param);
                rtnDtTemp = helper.FillTable("USP_PP3800_S1_UNION", CommandType.StoredProcedure, param);
        ...
        #region 폼 로더
        private void PP3800_Load(object sender, EventArgs e)
        {
            #region Grid 셋팅
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "WORKCENTERCODE", "작업장", false, GridColDataType_emu.VarChar, 150, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "TIME", "소요시간(분)", false, GridColDataType_emu.VarChar, 80, 100, Infragistics.Win.HAlign.Right, true, false, "#,###", null, null, null, null);
            ...
            _GridUtil.InitColumnUltraGrid(grid1, "WORKERID", "보급작업자", false, GridColDataType_emu.VarChar, 180, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "LADLECODE", "래더", false, GridColDataType_emu.VarChar, 140, 100, Infragistics.Win.HAlign.Left, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "RESTQTY", "투입전(%)", false, GridColDataType_emu.VarChar, 80, 100, Infragistics.Win.HAlign.Right, true, false, null, null, null, null, null);
            _GridUtil.InitColumnUltraGrid(grid1, "DISSQTY", "투입후(%)", false, GridColDataType_emu.VarChar, 80, 100, Infragistics.Win.HAlign.Right, true, false, null, null, null, null, null);
