...
namespace SAMMI.PP
{
 ...
 //           _GridUtil.InitColumnUltraGrid(grid1, "cavity", "CAVITY", false, GridColDataType_emu.Integer, 50, 100, Infragistics.Win.HAlign.Right, true, false, null, null, null, null, null);
            ...
            //_GridUtil.InitColumnUltraGrid(grid1, "LotRmQty", "Lot미발행", false, GridColDataType_emu.Integer, 100, 100, Infragistics.Win.HAlign.Right, false, false, "#,##0", null, null, null, null);
            //_GridUtil.InitColumnUltraGrid(grid1, "endDiffQty", "잔량조정", false, GridColDataType_emu.Integer, 100, 100, Infragistics.Win.HAlign.Right, false, false, "#,##0", null, null, null, null);
