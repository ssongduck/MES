...
namespace SAMMI.QM
{
    ...
    /// QM1601 class
    /// </summary>
    public partial class QM1601 : SAMMI.Windows.Forms.BaseMDIChildForm
    {
        #region Variable
        ...
        /// <summary>
        /// QM1601 disposed event
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void QM1601_Disposed(object sender, EventArgs e)
        {
            DetachEventHandlers();
        }
        ...
        {
            this.Disposed += new EventHandler(QM1601_Disposed);
        ...
        private DataTable GetMeasureyData()
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    command.Parameters.Add(new SqlParameter(string.Format("@{0}", "WORKCENTER_CODE"), "4D52"));
