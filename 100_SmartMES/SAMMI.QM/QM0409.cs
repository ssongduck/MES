...
namespace SAMMI.QM
{
    ...
    /// QM0409 class
    /// </summary>
    public partial class QM0409 : SAMMI.Windows.Forms.BaseMDIChildForm
    {
        #region Variable
        ...
        /// <summary>
        /// QM0409 disposed event
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void QM0409_Disposed(object sender, EventArgs e)
        {
            DetachEventHandlers();
        }
        ...
        {
            this.Disposed += new EventHandler(QM0409_Disposed);
