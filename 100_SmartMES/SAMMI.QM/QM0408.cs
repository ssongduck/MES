...
namespace SAMMI.QM
{
    ...
    /// QM0408 class
    /// </summary>
    public partial class QM0408 : SAMMI.Windows.Forms.BaseMDIChildForm
    {
        #region Variable
        ...
        /// <summary>
        /// QM0408 disposed event
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void QM0408_Disposed(object sender, EventArgs e)
        {
            DetachEventHandlers();
        }
        ...
        private void gridViewComplete_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (dr != null)
            {
                ...
                if (historyDr != null)
                {
                    lbl260OKNG_COM.Text = string.IsNullOrEmpty(string.Format("{0}", historyDr["JUDGE01"])) ? "N/A" : historyDr["JUDGE01"].ToString();
                    lbl260OKNG_COM.BackColor = (lbl260OKNG_COM.Text == "OK") ? Color.FromArgb(103, 228, 119) : (lbl260OKNG_COM.Text == "NG") ? Color.FromArgb(242, 119, 122) : Color.Transparent;
                    lbl270OKNG_COM1.Text = string.IsNullOrEmpty(string.Format("{0}", historyDr["JUDGE01"])) ? "N/A" : historyDr["JUDGE01"].ToString();
                    lbl270OKNG_COM1.BackColor = (lbl270OKNG_COM1.Text == "OK") ? Color.FromArgb(103, 228, 119) : (lbl270OKNG_COM1.Text == "NG") ? Color.FromArgb(242, 119, 122) : Color.Transparent;
                    lbl270OKNG_COM2.Text = string.IsNullOrEmpty(string.Format("{0}", historyDr["JUDGE01"])) ? "N/A" : historyDr["JUDGE01"].ToString();
                    lbl270OKNG_COM2.BackColor = (lbl270OKNG_COM2.Text == "OK") ? Color.FromArgb(103, 228, 119) : (lbl270OKNG_COM1.Text == "NG") ? Color.FromArgb(242, 119, 122) : Color.Transparent;
                    lbl280OKNG_COM.Text = string.IsNullOrEmpty(string.Format("{0}", historyDr["JUDGE01"])) ? "N/A" : historyDr["JUDGE01"].ToString();
                    lbl280OKNG_COM.BackColor = (lbl280OKNG_COM.Text == "OK") ? Color.FromArgb(103, 228, 119) : (lbl280OKNG_COM.Text == "NG") ? Color.FromArgb(242, 119, 122) : Color.Transparent;
                    ...
                    lblLastEventTime04_COM.Text = string.IsNullOrEmpty(string.Format("{0}", historyDr["LASTEVENT_TIME03"])) ? string.Empty : DateTime.Parse(historyDr["LASTEVENT_TIME04"].ToString()).ToString("yyyy-MM-dd HH:mm:ss");
                }
            }
        }
        ...
        private void gridViewError_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (dr != null)
            {
                ...
                if (historyDr != null)
                {
                    lbl260OKNG_ERR.Text = string.IsNullOrEmpty(string.Format("{0}", historyDr["JUDGE01"])) ? "N/A" : historyDr["JUDGE01"].ToString();
                    lbl260OKNG_ERR.BackColor = (lbl260OKNG_ERR.Text == "OK") ? Color.FromArgb(103, 228, 119) : (lbl260OKNG_ERR.Text == "NG") ? Color.FromArgb(242, 119, 122) : Color.Transparent;
                    lbl270OKNG_ERR1.Text = string.IsNullOrEmpty(string.Format("{0}", historyDr["JUDGE01"])) ? "N/A" : historyDr["JUDGE01"].ToString();
                    lbl270OKNG_ERR1.BackColor = (lbl270OKNG_ERR1.Text == "OK") ? Color.FromArgb(103, 228, 119) : (lbl270OKNG_ERR1.Text == "NG") ? Color.FromArgb(242, 119, 122) : Color.Transparent;
                    lbl270OKNG_ERR2.Text = string.IsNullOrEmpty(string.Format("{0}", historyDr["JUDGE01"])) ? "N/A" : historyDr["JUDGE01"].ToString();
                    lbl270OKNG_ERR2.BackColor = (lbl270OKNG_ERR2.Text == "OK") ? Color.FromArgb(103, 228, 119) : (lbl270OKNG_ERR2.Text == "NG") ? Color.FromArgb(242, 119, 122) : Color.Transparent;
                    lbl280OKNG_ERR.Text = string.IsNullOrEmpty(string.Format("{0}", historyDr["JUDGE01"])) ? "N/A" : historyDr["JUDGE01"].ToString();
                    lbl280OKNG_ERR.BackColor = (lbl280OKNG_ERR.Text == "OK") ? Color.FromArgb(103, 228, 119) : (lbl280OKNG_ERR.Text == "NG") ? Color.FromArgb(242, 119, 122) : Color.Transparent;
                    ...
                    lblLastEventTime04_ERR.Text = string.IsNullOrEmpty(string.Format("{0}", historyDr["LASTEVENT_TIME03"])) ? string.Empty : DateTime.Parse(historyDr["LASTEVENT_TIME04"].ToString()).ToString("yyyy-MM-dd HH:mm:ss");
                }
            }
        }
        ...
        private void gridViewIng_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (dr != null)
            {
                ...
                if (historyDr != null)
                {
                    lbl260OKNG_ING.Text = string.IsNullOrEmpty(string.Format("{0}", historyDr["JUDGE01"])) ? "N/A" : historyDr["JUDGE01"].ToString();
                    lbl260OKNG_ING.BackColor = (lbl260OKNG_ING.Text == "OK") ? Color.FromArgb(103, 228, 119) : (lbl260OKNG_ING.Text == "NG") ? Color.FromArgb(242, 119, 122) : Color.Transparent;
                    lbl270OKNG_ING1.Text = string.IsNullOrEmpty(string.Format("{0}", historyDr["JUDGE01"])) ? "N/A" : historyDr["JUDGE01"].ToString();
                    lbl270OKNG_ING1.BackColor = (lbl270OKNG_ING1.Text == "OK") ? Color.FromArgb(103, 228, 119) : (lbl270OKNG_ING1.Text == "NG") ? Color.FromArgb(242, 119, 122) : Color.Transparent;
                    lbl270OKNG_ING2.Text = string.IsNullOrEmpty(string.Format("{0}", historyDr["JUDGE01"])) ? "N/A" : historyDr["JUDGE01"].ToString();
                    lbl270OKNG_ING2.BackColor = (lbl270OKNG_ING2.Text == "OK") ? Color.FromArgb(103, 228, 119) : (lbl270OKNG_ING2.Text == "NG") ? Color.FromArgb(242, 119, 122) : Color.Transparent;
                    lbl280OKNG_ING.Text = string.IsNullOrEmpty(string.Format("{0}", historyDr["JUDGE01"])) ? "N/A" : historyDr["JUDGE01"].ToString();
                    lbl280OKNG_ING.BackColor = (lbl280OKNG_ING.Text == "OK") ? Color.FromArgb(103, 228, 119) : (lbl280OKNG_ING.Text == "NG") ? Color.FromArgb(242, 119, 122) : Color.Transparent;
                    ...
                    lblLastEventTime04_ING.Text = string.IsNullOrEmpty(string.Format("{0}", historyDr["LASTEVENT_TIME03"])) ? string.Empty : DateTime.Parse(historyDr["LASTEVENT_TIME04"].ToString()).ToString("yyyy-MM-dd HH:mm:ss");
                }
            }
        }
        ...
        /// <summary>
        /// Chart measure data custom draw crosshair event
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void chartMeasureData_CustomDrawCrosshair(object sender, CustomDrawCrosshairEventArgs e)
        {
        ...
        {
            this.Disposed += new EventHandler(QM0408_Disposed);
            ...
            chartMeasureData.CustomDrawCrosshair += new CustomDrawCrosshairEventHandler(chartMeasureData_CustomDrawCrosshair);
        ...
        /// Bind leak data
        /// </summary>
        private void BindLeakData()
        {
            //if (bandedGridView1.Columns["LOT_NO"].Summary.Count > 0) bandedGridView1.Columns["LOT_NO"].Summary.Clear();

            DataTable dt = GetLeakData();

            if (dt != null && dt.Rows.Count > 0)
            {
                gridControlLeakList.DataSource = dt;
                //bandedGridView1.Columns["LOT_NO"].Summary.Add(new GridColumnSummaryItem(SummaryItemType.Count, "LOT_NO", "전체 행:{0:#,###}건"));
            }
            else
            {
        ...
        private List<string> GetChkList()
        {
            ...
            if (chk05.Checked) { chkList.Add("DATA05"); }
            if (chk06.Checked) { chkList.Add("DATA06"); }
            if (chk07.Checked) { chkList.Add("DATA07"); }
            if (chk08.Checked) { chkList.Add("DATA08"); }
            if (chk09.Checked) { chkList.Add("DATA09"); }
            if (chk10.Checked) { chkList.Add("DATA10"); }
            if (chk11.Checked) { chkList.Add("DATA11"); }
            if (chk12.Checked) { chkList.Add("DATA12"); }
            if (chk13.Checked) { chkList.Add("DATA13"); }
        ...
        public DataTable GetCompleteHistoryData()
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    command.Parameters.Add(new SqlParameter(string.Format("@{0}", "WORKCENTER_CODE"), "4D53"));
        ...
        private DataTable GetItemSpecData()
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    command.Parameters.Add(new SqlParameter(string.Format("@{0}", "WORKCENTER_CODE"), "4D53"));
                    command.Parameters.Add(new SqlParameter(string.Format("@{0}", "ITEM_CODE"), "22141-2U000"));
        ...
        public DataTable GetLeakData()
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                try
                {
                    SqlCommand command = new SqlCommand(_sqlLeakData, connection);
                    command.CommandType = CommandType.Text;
        ...
        {
            lbl260OKNG_COM.Text = "N/A";
            lbl260OKNG_COM.BackColor = Color.Transparent;
            lbl270OKNG_COM1.Text = "N/A";
            lbl270OKNG_COM1.BackColor = Color.Transparent;
            lbl270OKNG_COM2.Text = "N/A";
            lbl270OKNG_COM2.BackColor = Color.Transparent;
            lbl280OKNG_COM.Text = "N/A";
            lbl280OKNG_COM.BackColor = Color.Transparent;
        ...
        {
            lbl260OKNG_ERR.Text = "N/A";
            lbl260OKNG_ERR.BackColor = Color.Transparent;
            lbl270OKNG_ERR1.Text = "N/A";
            lbl270OKNG_ERR1.BackColor = Color.Transparent;
            lbl270OKNG_ERR2.Text = "N/A";
            lbl270OKNG_ERR2.BackColor = Color.Transparent;
            lbl280OKNG_ERR.Text = "N/A";
            lbl280OKNG_ERR.BackColor = Color.Transparent;
        ...
        {
            lbl260OKNG_ING.Text = "N/A";
            lbl260OKNG_ING.BackColor = Color.Transparent;
            lbl270OKNG_ING1.Text = "N/A";
            lbl270OKNG_ING1.BackColor = Color.Transparent;
            lbl270OKNG_ING2.Text = "N/A";
            lbl270OKNG_ING2.BackColor = Color.Transparent;
            lbl280OKNG_ING.Text = "N/A";
            lbl280OKNG_ING.BackColor = Color.Transparent;
        ...
        public const string _sqlMeasureData =
            @"SELECT A.PLANT_CODE									                            AS PLANT_CODE
                    ...
                    ,A.DATA20                                                                   AS DATA20
                    ,A.DATA21                                                                   AS DATA21
                    ,A.LASTEVENT_TIME03                                                         AS LASTEVENT_TIME
                    ,A.LINE                                                                     AS LINE
                FROM TDS3001 A WITH(NOLOCK)
               WHERE 1 = 1
                 AND ISNULL(A.OPERATION03, '')	            <> ''
                 AND A.PLANT_CODE		                    = @PLANT_CODE
                 AND A.WORKCENTER_CODE                      = @WORKCENTER_CODE
                 AND A.LASTEVENT_TIME03                     BETWEEN @FROM_DT AND @TO_DT
                 AND ISNULL(A.JUDGE01, '')                  = 'OK'
        ...
        /// Get leak data
        /// </summary>
        public const string _sqlLeakData =
            @"SELECT A.LEAKTYPE                                                                 AS LEAKTYPE
                    ,A.QTY                                                                      AS QTY
                    ,A.MOLD                                                                     AS MOLD
                    ,CASE WHEN A.SHIFT = 'D'
                          THEN '주간'
                     ...
                     END                                                                        AS SHIFT
                    ,CASE WHEN A.SHIFT = 'D'
                          THEN A.CREATE_DT ELSE DATEADD(D, -1, A.CREATE_DT)
                     END                                                                        AS CREATE_DT
                FROM T_LEAK_RESULT A WITH(NOLOCK)
               WHERE 1 = 1
                 AND A.PLANTCODE        = @PLANT_CODE
                 AND A.FACTORY          = '20'
                 AND A.WORKCENTERCODE   = @WORKCENTER_CODE
                 AND A.CREATE_DT        BETWEEN @FROM_DT AND @TO_DT
              ORDER BY CASE WHEN A.SHIFT = 'D'
                            THEN CONVERT(CHAR(10), A.CREATE_DT, 120)
                            ELSE CONVERT(CHAR(10), DATEADD(D, -1, A.CREATE_DT), 120)
                       END
                      ,A.LEAKTYPE
                      ,A.SHIFT
                      ,A.MOLD";
