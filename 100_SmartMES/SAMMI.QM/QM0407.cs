...
namespace SAMMI.QM
{
    ...
    /// QM0407 class
    /// </summary>
    public partial class QM0407 : SAMMI.Windows.Forms.BaseMDIChildForm
    {
        #region Variable
        ...
        /// <summary>
        /// QM0407 disposed event
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void QM0407_Disposed(object sender, EventArgs e)
        {
            DetachEventHandlers();
        }
        ...
        private void gridViewComplete_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (dr != null)
            {
                ...
                if (historyDr != null)
                {
                    lbl270OKNG_COM.Text = string.IsNullOrEmpty(string.Format("{0}", historyDr["JUDGE01"])) ? "N/A" : historyDr["JUDGE01"].ToString();
                    lbl270OKNG_COM.BackColor = (lbl270OKNG_COM.Text == "OK") ? Color.FromArgb(103, 228, 119) : (lbl270OKNG_COM.Text == "NG") ? Color.FromArgb(242, 119, 122) : Color.Transparent;
                    lbl280OKNG_COM.Text = string.IsNullOrEmpty(string.Format("{0}", historyDr["JUDGE03"])) ? "N/A" : historyDr["JUDGE03"].ToString();
                    ...
                    lbl290OKNG_COM.Text = string.IsNullOrEmpty(string.Format("{0}", historyDr["JUDGE26"])) ? "N/A" : historyDr["JUDGE26"].ToString();
                    lbl290OKNG_COM.BackColor = (lbl290OKNG_COM.Text == "OK") ? Color.FromArgb(103, 228, 119) : (lbl290OKNG_COM.Text == "NG") ? Color.FromArgb(242, 119, 122) : Color.Transparent;
                    ...
                    lblLine_COM.Text = string.IsNullOrEmpty(string.Format("{0}", historyDr["LINE"])) ? string.Empty : historyDr["LINE"].ToString();
        ...
        private void gridViewError_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (dr != null)
            {
                ...
                if (historyDr != null)
                {
                    lbl270OKNG_ERR.Text = string.IsNullOrEmpty(string.Format("{0}", historyDr["JUDGE01"])) ? "N/A" : historyDr["JUDGE01"].ToString();
                    lbl270OKNG_ERR.BackColor = (lbl270OKNG_ERR.Text == "OK") ? Color.FromArgb(103, 228, 119) : (lbl270OKNG_ERR.Text == "NG") ? Color.FromArgb(242, 119, 122) : Color.Transparent;
                    lbl280OKNG_ERR.Text = string.IsNullOrEmpty(string.Format("{0}", historyDr["JUDGE03"])) ? "N/A" : historyDr["JUDGE03"].ToString();
                    ...
                    lbl290OKNG_ERR.Text = string.IsNullOrEmpty(string.Format("{0}", historyDr["JUDGE26"])) ? "N/A" : historyDr["JUDGE26"].ToString();
                    lbl290OKNG_ERR.BackColor = (lbl290OKNG_ERR.Text == "OK") ? Color.FromArgb(103, 228, 119) : (lbl290OKNG_ERR.Text == "NG") ? Color.FromArgb(242, 119, 122) : Color.Transparent;
        ...
        private void gridViewIng_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (dr != null)
            {
                ...
                if (historyDr != null)
                {
                    lbl270OKNG_ING.Text = string.IsNullOrEmpty(string.Format("{0}", historyDr["JUDGE01"])) ? "N/A" : historyDr["JUDGE01"].ToString();
                    lbl270OKNG_ING.BackColor = (lbl270OKNG_ING.Text == "OK") ? Color.FromArgb(103, 228, 119) : (lbl270OKNG_ING.Text == "NG") ? Color.FromArgb(242, 119, 122) : Color.Transparent;
                    lbl280OKNG_ING.Text = string.IsNullOrEmpty(string.Format("{0}", historyDr["JUDGE03"])) ? "N/A" : historyDr["JUDGE03"].ToString();
                    ...
                    lbl290OKNG_ING.Text = string.IsNullOrEmpty(string.Format("{0}", historyDr["JUDGE26"])) ? "N/A" : historyDr["JUDGE26"].ToString();
                    lbl290OKNG_ING.BackColor = (lbl290OKNG_ING.Text == "OK") ? Color.FromArgb(103, 228, 119) : (lbl290OKNG_ING.Text == "NG") ? Color.FromArgb(242, 119, 122) : Color.Transparent;
                    ...
                    lblLine_ING.Text = string.IsNullOrEmpty(string.Format("{0}", historyDr["LINE"])) ? string.Empty : historyDr["LINE"].ToString();
        ...
        {
            this.Disposed += new EventHandler(QM0407_Disposed);
        ...
        private void BindCompleteDataList()
        {
            ...
            _CompleteDt = GetCompleteHistoryData(line, zig);
        ...
        private void BindErrorDataList()
        {
            ...
            _ErrorDt = GetErrorHistoryData(line, zig);
        ...
        private void BindIngDataList()
        {
            ...
            _IngDt = GetIngHistoryData(line, zig);
        ...
        private void BinChartData()
        {
            ...
            _MeasureDt = GetMeasureData(line, zig);
        ...
        /// <param name="zig"></param>
        /// <returns></returns>
        public DataTable GetCompleteHistoryData(string line, string zig)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    command.Parameters.Add(new SqlParameter(string.Format("@{0}", "WORKCENTER_CODE"), "4J56"));
                    ...
                    command.Parameters.Add(new SqlParameter(string.Format("@{0}", "LINE"), line));
                    command.Parameters.Add(new SqlParameter(string.Format("@{0}", "ZIG"), zig));
        ...
        /// <param name="zig"></param>
        /// <returns></returns>
        public DataTable GetErrorHistoryData(string line, string zig)
        {
            string sPlantCode = SqlDBHelper.nvlString(this.cboPlantCode_H.Value);
            sPlantCode = string.IsNullOrEmpty(sPlantCode) ? "%" : sPlantCode;
        ...
        /// <param name="zig"></param>
        /// <returns></returns>
        public DataTable GetIngHistoryData(string line, string zig)
        {
            string sPlantCode = SqlDBHelper.nvlString(this.cboPlantCode_H.Value);
            sPlantCode = string.IsNullOrEmpty(sPlantCode) ? "%" : sPlantCode;
        ...
        /// <param name="zig"></param>
        /// <returns></returns>
        public DataTable GetData(string line, string zig)
        {
            string sPlantCode = SqlDBHelper.nvlString(this.cboPlantCode_H.Value);
            sPlantCode = string.IsNullOrEmpty(sPlantCode) ? "%" : sPlantCode;
        ...
        /// <param name="zig"></param>
        /// <returns></returns>
        public DataTable GetMeasureData(string line, string zig)
        {
            string sPlantCode = SqlDBHelper.nvlString(this.cboPlantCode_H.Value);
            sPlantCode = string.IsNullOrEmpty(sPlantCode) ? "%" : sPlantCode;
        ...
        {
            lbl270OKNG_COM.Text = "N/A";
            lbl270OKNG_COM.BackColor = Color.Transparent;
            lbl280OKNG_COM.Text = "N/A";
            lbl280OKNG_COM.BackColor = Color.Transparent;
            lbl290OKNG_COM.Text = "N/A";
            lbl290OKNG_COM.BackColor = Color.Transparent;
        ...
        {
            lbl270OKNG_ERR.Text = "N/A";
            lbl270OKNG_ERR.BackColor = Color.Transparent;
            lbl280OKNG_ERR.Text = "N/A";
            lbl280OKNG_ERR.BackColor = Color.Transparent;
            lbl290OKNG_ERR.Text = "N/A";
            lbl290OKNG_ERR.BackColor = Color.Transparent;
        ...
        {
            lbl270OKNG_ING.Text = "N/A";
            lbl270OKNG_ING.BackColor = Color.Transparent;
            lbl280OKNG_ING.Text = "N/A";
            lbl280OKNG_ING.BackColor = Color.Transparent;
            lbl290OKNG_ING.Text = "N/A";
            lbl290OKNG_ING.BackColor = Color.Transparent;
        ...
        public const string _sqlGetCompleteHistoryData =
            @"SELECT A.PLANT_CODE									                            AS PLANT_CODE
               ...
               WHERE 1 = 1
                 ...
                 AND A.JUDGE            = 'OK'
                 AND SUBSTRING(ISNULL(A.LINE, ''), 1, 1)    LIKE @LINE
                 AND SUBSTRING(ISNULL(A.LINE, ''), 3, 1)    LIKE @ZIG";
