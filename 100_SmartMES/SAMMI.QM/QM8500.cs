...
namespace SAMMI.QM
{
    public partial class QM8500 : SAMMI.Windows.Forms.BaseMDIChildForm
    {
        #region <MEMBER AREA>
       ...
       // public DataTable DtTable = new DataTable();
        ...
        public QM8500()
        {
            ...
            this.InitChart();
            /*트리 생성*/
            //this.daTable3.Fill(this.ds.dTable2);
        ...
        private ChartLayerAppearance mrlineLayer = new ChartLayerAppearance();
        ...
        public void InitChart()
        {
            ...
            this.mrlineLayer.ChartArea = mrChartArea;
            this.mrlineLayer.ChartType = ChartType.LineChart;
            this.mrlineLayer.AxisX = xAxis1;
            this.mrlineLayer.AxisY = yAxis1;
            ...
            series_mr_agv = new NumericSeries();
            ...
            series_cl.PEs.Add(new PaintElement(Color.Black));
            ...
            series_mr_agv.PEs.Add(new PaintElement(Color.Green));
            ...
            this.lineLayer.Series.Add(series_i_avg);
            this.lineLayer_value.Series.Add(series_value);
            this.mrlineLayer.Series.Add(series_mr_value);
            ...
            ((LineChartAppearance)this.mrlineLayer.ChartTypeAppearance).Thickness = 1;
            ((LineChartAppearance)this.mrlineLayer.ChartTypeAppearance).DrawStyle = LineDrawStyle.Solid;
        ...
        public override void DoInquire()
        {
            ...
            DateTime frRegDT = System.DateTime.Now;
            DateTime toRegDT = System.DateTime.Now.AddHours(-1);
            string sStartDate = SqlDBHelper.nvlDateTime(frRegDT).ToString("yyyy-MM-dd HH:mm:ss");                           // 생산시작일자
            
            string sEndDate = SqlDBHelper.nvlDateTime(toRegDT).ToString("yyyy-MM-dd HH:mm:ss");
            ...
            this.series_mr_agv.Points.Clear();
            this.series_histogram_value.Points.Clear();
            this.HistogramChart.Layer.Clear();
            this.I_chart.CompositeChart.Legends.Clear();
            this.R_Chart.CompositeChart.Legends.Clear();

            // 새로 조회시 Scale 초기화
            this.lineLayer.AxisY.ScrollScale.Scale = 1;
            this.lineLayer.AxisX.ScrollScale.Scale = 1;
            this.lineLayer_value.AxisY.ScrollScale.Scale = 1;
            this.lineLayer_value.AxisX.ScrollScale.Scale = 1;
            this.mrlineLayer.AxisY.ScrollScale.Scale = 1;
            this.mrlineLayer.AxisX.ScrollScale.Scale = 1;
            this.I = 0.0;
            this.USL = 0.0;
            this.LSL = 0.0;
            ...
            try
            {
                ...
                param1[5] = helper.CreateParameter("A2", this.A2, SqlDbType.VarChar, ParameterDirection.Input);   // 작업장 코드     
                param1[6] = helper.CreateParameter("D4", this.D3, SqlDbType.VarChar, ParameterDirection.Input);   // 작업장 코드     
                param1[7] = helper.CreateParameter("D3", this.D4, SqlDbType.VarChar, ParameterDirection.Input);   // 작업장 코드
                param1[8] = helper.CreateParameter("CNT", CNT, SqlDbType.Int, ParameterDirection.Input);   // 작업장 코드

                rtnDtTemp = helper.FillTable("USP_QM8500_S5_UNION", CommandType.StoredProcedure, param1);
                ...
                if (this.rtnDtTemp.Rows.Count == 0)
                {
                    ...
                    //throw ex;
                    ShowDialog("조회할 데이터가 없습니다.(최근 1시간)", Windows.Forms.DialogForm.DialogType.OK);
                    return;
                }
        ...
        private void GetSeries()
        {
            for (int i = 0; i < this.CNT; i++)
            {
               ...
               series_i_avg.Points.Add(new NumericDataPoint(this.I_AVG_ALL, "", false));//(i + 1).ToString(), false));
        ...
        private void Grid_Data(DataTable dt)
        {
            ...
            try
            {
                for (int i = 0; i < dt.Rows.Count - 1; i++)
                {
                    ...
                    this.DtTable.Rows[1][i + 1] = Math.Round(Convert.ToDouble(dt.Rows[i]["I"].ToString()), 6).ToString();
                    this.DtTable.Rows[2][i + 1] = Math.Round(Convert.ToDouble(dt.Rows[i]["MR"].ToString()), 6).ToString();
        ...
        private void QM8500_Load(object sender, EventArgs e)
        {
            // TODO: 이 코드는 데이터를 'qM8300D.dTable3' 테이블에 로드합니다. 필요한 경우 이 코드를 이동하거나 제거할 수 있습니다.
           // this.daTable3.Fill(this.ds.dTable3, this.PlantCode);
