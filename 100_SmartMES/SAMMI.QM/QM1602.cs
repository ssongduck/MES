...
namespace SAMMI.QM
{
    ...
    /// QM1602 class
    /// </summary>
    public partial class QM1602 : SAMMI.Windows.Forms.BaseMDIChildForm
    {
        #region Variable
        ...
        /// <summary>
        /// QM1602 disposed event
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void QM1602_Disposed(object sender, EventArgs e)
        {
            DetachEventHandlers();
        }
        ...
        private void gridViewMeasure_RowStyle(object sender, RowStyleEventArgs e)
        {
            ...
            if (e.RowHandle >= 0)
            {
                if (gridView.GetRowCellDisplayText(e.RowHandle, gridView.Columns["JUDGE01"]) == "NG" ||
                    ...
                    gridView.GetRowCellDisplayText(e.RowHandle, gridView.Columns["JUDGE12"]) == "NG" ||
                    gridView.GetRowCellDisplayText(e.RowHandle, gridView.Columns["JUDGE13"]) == "NG" ||
                    gridView.GetRowCellDisplayText(e.RowHandle, gridView.Columns["JUDGE14"]) == "NG" ||
                    gridView.GetRowCellDisplayText(e.RowHandle, gridView.Columns["JUDGE15"]) == "NG" ||
                    gridView.GetRowCellDisplayText(e.RowHandle, gridView.Columns["JUDGE16"]) == "NG" ||
                    gridView.GetRowCellDisplayText(e.RowHandle, gridView.Columns["JUDGE17"]) == "NG" ||
                    gridView.GetRowCellDisplayText(e.RowHandle, gridView.Columns["JUDGE18"]) == "NG" ||
                    gridView.GetRowCellDisplayText(e.RowHandle, gridView.Columns["JUDGE19"]) == "NG" ||
                    gridView.GetRowCellDisplayText(e.RowHandle, gridView.Columns["JUDGE20"]) == "NG" ||
                    gridView.GetRowCellDisplayText(e.RowHandle, gridView.Columns["JUDGE21"]) == "NG")
                {
        ...
        private void InitializeGridControl()
        {
            if (_SpecDt != null && _SpecDt.Rows.Count > 0)
            {
                ...
                gridViewMeasure.Columns.AddField("JUDGE13");
                gridViewMeasure.Columns["JUDGE13"].VisibleIndex = 3;
                gridViewMeasure.Columns["JUDGE13"].Caption = "최종판정";
                gridViewMeasure.Columns["JUDGE13"].AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
                gridViewMeasure.Columns["JUDGE13"].AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
        ...
        {
            this.Disposed += new EventHandler(QM1602_Disposed);
