...
namespace SAMMI.QM
{
    ...
    /// QM1604 class
    /// </summary>
    public partial class QM1604 : SAMMI.Windows.Forms.BaseMDIChildForm
    {
        #region Variable
        ...
        /// <summary>
        /// QM1604 disposed event
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void QM1604_Disposed(object sender, EventArgs e)
        {
            DetachEventHandlers();
        }
        ...
        {
            this.Disposed += new EventHandler(QM1604_Disposed);
        ...
        private DataTable GetMeasureyData()
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    if (itemCode == "43115-2B001")
                    {
                        itemCode = "43115-2B000";
                    }
                    ...
                    command.Parameters.Add(new SqlParameter(string.Format("@{0}", "WORKCENTER_CODE"), "4D55"));
                    command.Parameters.Add(new SqlParameter(string.Format("@{0}", "ITEM_CODE"), itemCode));
