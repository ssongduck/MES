...
{
    public partial class POP_TBM0300 : Form
    {
        string[] argument;
        ...
        public POP_TBM0300(string[] param)
        {
            ...
            DataTable rtnDtTemp = _Common.GET_TBM0000_CODE("CUSTTYPE");  //사업장
            ...
            for (int i = 0; i < param.Length; i++)
            {
                ...
                switch (i)
                {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        cboCustType_H.SelectedValue = argument[2] == "" ? "ALL" : argument[2];
                        break;
                    case 3:
                        cboUseFlag_H.SelectedValue = argument[3] == "" ? "ALL" : argument[3];
                        break;
                }
                #endregion
            }
        ...
        private void search()
        {
            ...
            Common.Common _Common = new Common.Common();
            rtnDtTemp = _Common.GET_TBM0000_CODE("CUSTTYPE");  //거래처
            SAMMI.Common.UltraGridUtil.SetComboUltraGrid(this.Grid1, "CustType", rtnDtTemp, "CODE_ID", "CODE_NAME");
