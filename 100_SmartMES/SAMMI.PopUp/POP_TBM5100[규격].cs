...
{
    public partial class POP_TBM5100  : Form
    {
        string[] argument;
        ...
        public POP_TBM5100 (string[] param)
        {
            InitializeComponent();
        ...
        private void POP_TBM5100_Load(object sender, EventArgs e)
        {
        ...
        private void search()
        {
            ...
            _DtTemp = _biz.SEL_TBM5100(sitem_cd ,sitem_name );
